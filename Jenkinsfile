node {
    ...
    stage('Code syncing') {
        checkout poll: false, scm: [$class: 'RepoScm', currentBranch: true, destinationDir: '/unlegacy/build_config', forceSync: true, jobs: 8, manifestBranch: '${BRANCH}', manifestRepositoryUrl: 'https://github.com/Unlegacy-Android/build_config.git', noTags: true, quiet: true]
